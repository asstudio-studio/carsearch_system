...
?>
    <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
            <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
                ...
                <span class="mdc-top-app-bar__title">汽車商店</span>
            </section>
    ...
    <center>
        ...
        <div class="row">
            <h3 class="inline brown-text"> 商店名單</h3>
            <form class="inline col s5 offset-s7 " method="post" >
                <div class="row inline">
                    <div class="input-field col s8">
                        <i class="material-icons prefix ">search</i>
                        <input id="textarea1"  placeholder="查詢地區" class="materialize-textarea" type="text" name="searchWord"></input>
...
if(isset($_SESSION["hasSignedIn"]) && $_SESSION["hasSignedIn"]==true){
    ...
    if($_SESSION['user_level']=='s'){
        echo '<div class="fixed-action-btn">
                <a class="btn-floating btn-large red"  onclick=location.href="storeadd.php">

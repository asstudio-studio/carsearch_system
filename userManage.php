...
<header class="mdc-top-app-bar">
    ...
    <center>
        ...
        <h3 class="inline brown-text"> 使用者管理</h3>
        <div class="row">
            ...
            <form class="inline col s4 offset-s7 " method="post" >
                <div class="row inline">
                    ...
                    <p></p>
                    <input class="inline btn waves-effect waves-light btn-small margin5 vertical-center gray lighten-3" type="submit"  name="submit" value="查詢">
                </div>
        ...
        <br>
        <br>
        <a class="waves-effect waves-light btn-small margin5 gray lighten-3" onclick=location.href="index.php">回到標題</a>

    </center>
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large gray"  onclick=location.href="userAdd.php">

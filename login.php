...
<center>
    ...
    <div class="row">
        <form class="col s6 offset-s3" action="" method="post">
            ...
            <input class=" btn waves-effect waves-light btn-small margin5 gray lighten-3" type="submit"  name="submit" value="用戶登入">
            <!--    <a class="waves-effect waves-light btn-small margin5" onclick="location.href='mipsEmulator.html';">忘記密碼</a>-->
            <a class="waves-effect waves-light btn-small margin5 gray lighten-3" onclick="location.href='register.php';">註冊</a>
        </form>
    </div>
